...
final class Version20200426001647 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE account (id INT AUTO_INCREMENT NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, street VARCHAR(255) NOT NULL, housenumber VARCHAR(10) NOT NULL, zipcode VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, type VARCHAR(255) DEFAULT NULL, company VARCHAR(255) DEFAULT NULL, token VARCHAR(255) DEFAULT NULL, verified_at DATETIME DEFAULT NULL, created_at DATETIME DEFAULT NULL, reviewed_at DATETIME DEFAULT NULL, reviewer VARCHAR(255) DEFAULT NULL, is_rejected TINYINT(1) NOT NULL, score NUMERIC(2, 1) DEFAULT NULL, UNIQUE INDEX UNIQ_7D3656A4E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
