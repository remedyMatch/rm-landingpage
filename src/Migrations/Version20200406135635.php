...
final class Version20200406135635 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO account (id, firstname, lastname, email, street, housenumber, zipcode, city, phone, type, company, token, verified_at, created_at) SELECT id, firstname, lastname, email, street, housenumber, zipcode, city, phone, type, company, token, verified_at, created_at FROM __temp__account');
