...
class DefaultController extends AbstractController
{
    ...
    /**
     * @Route({ "de": "/impressum", "en": "/imprint" }, name="impressum")
     * @return Response
     */
    ...
    /**
     * @Route({ "de": "/datenschutz", "en": "/dataprotection" }, name="datenschutz")
     * @return Response
     */
    ...
    /**
     * @Route({ "de": "/presse", "en": "/press" }, name="presse")
     * @return Response
     */
    ...
    /**
     * @Route({ "de": "/offene-positionen", "en": "/vacant-positions" }, name="jobs")
     * @param Request $request
     * @return Response
     */
